 ...
 //colors decllaration for status
  ...
  const handleViewInvoice = async (project_code) => {
      try {
        ...
        const response = await axios.get(`${local_uri}/api/admin/invoice/${project_code}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 overflow-auto max-h-[400px] p-2 border border-gray-200 rounded">
          <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-base font-semibold">{selectedProjectForDetails.project_name}</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4">
              <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Admin Note</h3>
              ...
              {selectedProjectForDetails.admin_notes ? (
                ...
                <p className="text-base text-gray-500 italic">No notes are available</p>
              )}
            </div>
                    ...
                    {selectedTicket.pdf_url ? (
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          ...
                          <span>{selectedTicket.pdf_url.split("/").pop()}</span>
                        </div>
                        <a
                ...
                <div>
                  ...
                  {selectedTicket.report_note ? (
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-900 dark:text-white italic">
                      <p className="text-gray-900 dark:text-white">{selectedTicket.report_note}</p>
                    </div>
                  ) : (
